<template>
  <section class="login-outer">
    <div class="login-wrapper" :style="loginWrapStyle">
      ...
      <div class="login-content">
        ...
        <div v-if="curPanel === 'sign'">
          <div class="flow-tabs">
            <span v-for="(item, index) in labels" :key="item.key" :class="['tab', { active: item.key === curLabel }]" @click="clickHandler(index)">{{ item.text }}</span>
          </div>
          <div class="container">
    ...
    <div class="logo-right">
      <svg fill="#fff" width="240" height="42" viewBox="0 0 5882 1024" xmlns="http://www.w3.org/2000/svg">
        <path
    ...
    <div class="logo-l">
      <svg fill="#fff" width="50" height="50" viewBox="0 0 56 56" xmlns="http://www.w3.org/2000/svg">
        <path
